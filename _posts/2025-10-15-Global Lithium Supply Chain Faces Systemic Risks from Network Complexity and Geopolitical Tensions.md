---
title: "Global Lithium Supply Chain Faces Systemic Risks from Network Complexity and Geopolitical Tensions"
image: images/20251015post_lithium.png
tags: Research, Supply-chain, Circular-economy, Sustainability
---
...
Lithium is essential for **electric vehicle batteries** and the **global energy transition**. However, the **geographical mismatch** between production and consumption regions, combined with **highly concentrated supply sources** and **complex global trade networks**, exposes the supply chain to unprecedented risks:
...
The research breaks new ground by combining:

- **Trade-linked material flow analysis**
- **Multi-layer network modeling**

This created a comprehensive map of the global lithium supply chain across **six life cycle stages**:
...
The team extended traditional static network metrics (e.g. **degree centrality**, **closeness centrality**, **betweenness centrality**, **eigenvector centrality**, **PageRank**, and **Laplacian centrality**) to multi-layer networks, and adapted **dynamic cascading failure models** to directed, weighted multi-layer networks.

## Key Findings

### Highly Interconnected but Geographically Concentrated

In **2022**, the lithium supply chain multi-layer network comprised:

- **865 nodes** across **225 countries** and **6 life cycle stages**
- **14,362 intra-layer links** (trade relationships)
- **634 inter-layer links** (production, processing, and consumption relationships)

Critical statistics include:
...
- **55%** of basic lithium chemicals (**119 kt** out of **218 kt**) are traded internationally  
  - Major exporters: **Chile, Argentina, Netherlands, China**  
  - Major importers: **South Korea, Japan, US**
- **China** exports approximately **30 kt** of chemical derivatives and **10 kt** of final products

Key players: **Australia, China, Chile, Japan, South Korea, US, EU** — creating both **efficiency** and **vulnerability**.
...
- **Direct Impact**:  
  China-US lithium trade = only **3%** of global trade volume → even **100% decoupling** does **not** improve US systemic risk position.

- **Indirect Impact**:  
  Cascading effects are substantial:
...
The research calls for **global cooperation** to avoid **"zero-sum games"** in securing lithium supply chains. As geopolitical tensions intensify and supply chains shift from **global integration** toward **diversified confrontation**, policymakers must:

- Move beyond simple diversification
- Optimize **network topology** to balance **efficiency** and **security**

Countries with high vulnerability need:

- **Internal optimization** to improve self-sufficiency
- **External cooperation** to integrate domestic industries into regional/global supply chains  
→ Enhancing **competitive position** and **bargaining power**

**Read the full paper**: https://doi.org/10.1021/acs.est.4c10523
